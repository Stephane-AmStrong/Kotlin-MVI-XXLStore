package stephane.amstrong.kotlinmvixxlstore.business.domain.util
...
class ErrorHandling{
    ...
    companion object{
        ...
        const val ERROR_CATEGORY_UNABLE_TO_RETRIEVE = "Unable to retrieve the blog post. Try reselecting it from the list."
        const val ERROR_CATEGORY_DOES_NOT_EXIST = "That BlogPost does not exist on the server."
